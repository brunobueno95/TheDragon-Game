function updateViewFind() {
    ...
    width: 98.5vw;
    height: 80vh;
    background-image:    url(imgs/forestsn.png);
    ...
    if(something.picture.includes("creature") ){
       let html=""
        ...
        `
            ...
            <div>
            <img src="${something.picture}" style="height:400px;width:250px;"><b
        ...
        html     += `
            ...
            <div>
            <button style="width:200px;height:40px; font-size: 15px; padding-bottom: 12px;" onclick="collectMaterial()">Check finding</button>
        </div>
        ` 
    ...
    if(something.picture.includes("gold") ){
        ...
        <div class="random-find">
           <div>
            ...
            <div>
            <button style="width:200px;height:40px;font-size: 15px; padding-bottom: 12px;" onclick="collectCoins()">Check finding</button>
            </div>
        </div>
        `
